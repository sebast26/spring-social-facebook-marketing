...
public class AdSetTemplateTest extends AbstractFacebookAdsApiTest {
	...
	public void getCampaignAdsets() throws Exception {
		mockServer.expect(requestTo("https://graph.facebook.com/v2.4/600123456789/adcampaigns?fields=account_id%2Cbid_info%2Cbilling_event%2Cbid_type%2Cbudget_remaining%2Ccampaign_group_id%2Ccampaign_status%2Ccreated_time%2Ccreative_sequence%2Cdaily_budget%2Cend_time%2Cid%2Cis_autobid%2Clifetime_budget%2Cname%2Coptimization_goal%2Cpromoted_object%2Cstart_time%2Ctargeting%2Cupdated_time"))
				.andExpect(method(GET))
				.andExpect(header("Authorization", "OAuth someAccessToken"))
				.andRespond(withSuccess(jsonResource("ad-sets"), MediaType.APPLICATION_JSON));
	...
	public void getAdSet() throws Exception {
		mockServer.expect(requestTo("https://graph.facebook.com/v2.4/700123456789?fields=account_id%2Cbid_info%2Cbilling_event%2Cbid_type%2Cbudget_remaining%2Ccampaign_group_id%2Ccampaign_status%2Ccreated_time%2Ccreative_sequence%2Cdaily_budget%2Cend_time%2Cid%2Cis_autobid%2Clifetime_budget%2Cname%2Coptimization_goal%2Cpromoted_object%2Cstart_time%2Ctargeting%2Cupdated_time"))
				.andExpect(method(GET))
				.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void getAdSet_wrongStatus() throws Exception {
		mockServer.expect(requestTo("https://graph.facebook.com/v2.4/709123456789?fields=account_id%2Cbid_info%2Cbilling_event%2Cbid_type%2Cbudget_remaining%2Ccampaign_group_id%2Ccampaign_status%2Ccreated_time%2Ccreative_sequence%2Cdaily_budget%2Cend_time%2Cid%2Cis_autobid%2Clifetime_budget%2Cname%2Coptimization_goal%2Cpromoted_object%2Cstart_time%2Ctargeting%2Cupdated_time"))
				.andExpect(method(GET))
				.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void getAdSet_wrongBidType() throws Exception {
		mockServer.expect(requestTo("https://graph.facebook.com/v2.4/710123456789?fields=account_id%2Cbid_info%2Cbilling_event%2Cbid_type%2Cbudget_remaining%2Ccampaign_group_id%2Ccampaign_status%2Ccreated_time%2Ccreative_sequence%2Cdaily_budget%2Cend_time%2Cid%2Cis_autobid%2Clifetime_budget%2Cname%2Coptimization_goal%2Cpromoted_object%2Cstart_time%2Ctargeting%2Cupdated_time"))
				.andExpect(method(GET))
				.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void getAdSet_withPromotedObject() throws Exception {
		mockServer.expect(requestTo("https://graph.facebook.com/v2.4/705123456789?fields=account_id%2Cbid_info%2Cbilling_event%2Cbid_type%2Cbudget_remaining%2Ccampaign_group_id%2Ccampaign_status%2Ccreated_time%2Ccreative_sequence%2Cdaily_budget%2Cend_time%2Cid%2Cis_autobid%2Clifetime_budget%2Cname%2Coptimization_goal%2Cpromoted_object%2Cstart_time%2Ctargeting%2Cupdated_time"))
				.andExpect(method(GET))
				.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void createAdSet() throws Exception {
		String requestBody = "date_format=U&name=Test+AdSet&campaign_status=PAUSED&is_autobid=true&billing_event=CLICKS&optimization_goal=CLICKS&bid_type=ABSOLUTE_OCPM&daily_budget=null&lifetime_budget=200&targeting=%7B%22geo_locations%22%3A%7B%22countries%22%3A%5B%22PL%22%5D%7D%7D&end_time=1432231200&campaign_group_id=600123456789";
	...
	public void createAdSet_withAllFields() throws Exception {
		String requestBody = "date_format=U&name=Test+AdSet+2&campaign_status=ACTIVE&is_autobid=false&" +
				...
				"billing_event=APP_INSTALLS&optimization_goal=CLICKS&" +
	...
	public void createAdSet_withPromotedObject() throws Exception {
		String requestBody = "date_format=U&name=Test+AdSet&campaign_status=PAUSED&is_autobid=true&billing_event=CLICKS&optimization_goal=CLICKS&bid_type=ABSOLUTE_OCPM&daily_budget=null&lifetime_budget=200&promoted_object=%7B%22page_id%22%3A%22111222333444555%22%7D&targeting=%7B%22geo_locations%22%3A%7B%22countries%22%3A%5B%22PL%22%5D%7D%7D&end_time=1432231200&campaign_group_id=600123456789";
		mockServer.expect(requestTo("https://graph.facebook.com/v2.4/act_123456789/adcampaigns"))
				.andExpect(method(POST))
				.andExpect(header("Authorization", "OAuth someAccessToken"))
				.andExpect(content().string(requestBody))
