...
public class AdSetTemplateTest extends AbstractFacebookAdsApiTest {
	...
	public void getAdSet() throws Exception {
		mockServer.expect(requestTo("https://graph.facebook.com/v2.4/700123456789?fields=account_id%2Cbid_info%2Cbilling_event%2Cbid_amount%2Cbid_type%2Cbudget_remaining%2Ccampaign_group_id%2Ccampaign_status%2Ccreated_time%2Ccreative_sequence%2Cdaily_budget%2Cend_time%2Cid%2Cis_autobid%2Clifetime_budget%2Cname%2Coptimization_goal%2Cpromoted_object%2Cstart_time%2Ctargeting%2Cupdated_time"))
				.andExpect(method(GET))
				.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void getAdSet_wrongStatus() throws Exception {
		mockServer.expect(requestTo("https://graph.facebook.com/v2.4/709123456789?fields=account_id%2Cbid_info%2Cbilling_event%2Cbid_amount%2Cbid_type%2Cbudget_remaining%2Ccampaign_group_id%2Ccampaign_status%2Ccreated_time%2Ccreative_sequence%2Cdaily_budget%2Cend_time%2Cid%2Cis_autobid%2Clifetime_budget%2Cname%2Coptimization_goal%2Cpromoted_object%2Cstart_time%2Ctargeting%2Cupdated_time"))
				.andExpect(method(GET))
				.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void getAdSet_wrongBidType() throws Exception {
		mockServer.expect(requestTo("https://graph.facebook.com/v2.4/710123456789?fields=account_id%2Cbid_info%2Cbilling_event%2Cbid_amount%2Cbid_type%2Cbudget_remaining%2Ccampaign_group_id%2Ccampaign_status%2Ccreated_time%2Ccreative_sequence%2Cdaily_budget%2Cend_time%2Cid%2Cis_autobid%2Clifetime_budget%2Cname%2Coptimization_goal%2Cpromoted_object%2Cstart_time%2Ctargeting%2Cupdated_time"))
				.andExpect(method(GET))
				.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void getAdSet_withPromotedObject() throws Exception {
		mockServer.expect(requestTo("https://graph.facebook.com/v2.4/705123456789?fields=account_id%2Cbid_info%2Cbilling_event%2Cbid_amount%2Cbid_type%2Cbudget_remaining%2Ccampaign_group_id%2Ccampaign_status%2Ccreated_time%2Ccreative_sequence%2Cdaily_budget%2Cend_time%2Cid%2Cis_autobid%2Clifetime_budget%2Cname%2Coptimization_goal%2Cpromoted_object%2Cstart_time%2Ctargeting%2Cupdated_time"))
				.andExpect(method(GET))
				.andExpect(header("Authorization", "OAuth someAccessToken"))
	...
	public void createAdSet_withAllFields() throws Exception {
		String requestBody = "date_format=U&name=Test+AdSet+2&campaign_status=ACTIVE&is_autobid=false&" +
				...
				"billing_event=APP_INSTALLS&optimization_goal=CLICKS&bid_amount=2222&" +
	...
	public void updateAdSet() throws Exception {
		String requestBody = "date_format=U&name=New+AdSet+name&campaign_status=ARCHIVED&is_autobid=true&bid_amount=0&daily_budget=null&lifetime_budget=50000&start_time=1432833720";
